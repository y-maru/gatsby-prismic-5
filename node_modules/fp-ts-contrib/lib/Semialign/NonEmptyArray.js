...
exports.semialignNonEmptyArray = void 0;
/**
 * @since 0.1.0
 */
...
exports.semialignNonEmptyArray = {
    ...
    alignWith: function (fa, fb, f) {
        return (0, NonEmptyArray_1.cons)(f((0, These_1.both)((0, NonEmptyArray_1.head)(fa), (0, NonEmptyArray_1.head)(fb))), Array_1.alignArray.alignWith((0, NonEmptyArray_1.tail)(fa), (0, NonEmptyArray_1.tail)(fb), f));
    },
    /**
    ...
    align: function (fa, fb) {
        return (0, NonEmptyArray_1.cons)((0, These_1.both)((0, NonEmptyArray_1.head)(fa), (0, NonEmptyArray_1.head)(fb)), Array_1.alignArray.align((0, NonEmptyArray_1.tail)(fa), (0, NonEmptyArray_1.tail)(fb)));
    }
};
