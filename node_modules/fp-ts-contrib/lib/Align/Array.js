...
exports.rpadZip = exports.rpadZipWith = exports.lpadZip = exports.lpadZipWith = exports.alignArray = void 0;
/**
 * @since 0.1.0
 */
...
exports.alignArray = {
    ...
    alignWith: function (fa, fb, f) {
        ...
        for (var i = 0; i < len; i++) {
            fc[i] = f((0, These_1.both)(fa[i], fb[i]));
        }
        if (aLen > bLen) {
            for (var i = bLen; i < aLen; i++) {
                fc[i] = f((0, These_1.left)(fa[i]));
            }
        }
        else {
            for (var i = aLen; i < bLen; i++) {
                fc[i] = f((0, These_1.right)(fb[i]));
            }
        }
        return fc;
    },
 ...
 * @since 0.1.0
 */
var lpadZipWith = function (xs, ys, f) { return Array_1.array.compact((0, _1.padZipWith)(exports.alignArray)(xs, ys, function (ma, mb) { return Option_1.option.map(mb, function (b) { return f(ma, b); }); })); };
 ...
 * @since 0.1.0
 */
var lpadZip = function (xs, ys) {
    return (0, exports.lpadZipWith)(xs, ys, function (a, b) { return (0, function_1.tuple)(a, b); });
};
 ...
 * @since 0.1.0
 */
var rpadZipWith = function (xs, ys, f) { return (0, exports.lpadZipWith)(ys, xs, function (a, b) { return f(b, a); }); };
 ...
 * @since 0.1.0
 */
var rpadZip = function (xs, ys) {
    return (0, exports.rpadZipWith)(xs, ys, function (a, b) { return (0, function_1.tuple)(a, b); });
};
