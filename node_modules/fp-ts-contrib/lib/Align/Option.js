...
exports.alignOption = {
    ...
    alignWith: function (fa, fb, f) {
        if ((0, Option_1.isSome)(fa) && (0, Option_1.isSome)(fb)) {
            return (0, Option_1.some)(f((0, These_1.both)(fa.value, fb.value)));
        }
        else if ((0, Option_1.isNone)(fa) && (0, Option_1.isSome)(fb)) {
            return (0, Option_1.some)(f((0, These_1.right)(fb.value)));
        }
        else if ((0, Option_1.isSome)(fa) && (0, Option_1.isNone)(fb)) {
            return (0, Option_1.some)(f((0, These_1.left)(fa.value)));
        }
        else {
