...
exports.isImpure = exports.isPure = exports.free = exports.Apply = exports.Applicative = exports.Functor = exports.URI = exports.of = exports.flatten = exports.chain = exports.ap = exports.map = exports.hoistFree = exports.foldFree = exports.liftF = void 0;
 ...
 * @since 0.1.3
 */
var liftF = function (fa) { return impure(fa, function (a) { return exports.free.of(a); }); };
exports.liftF = liftF;
function foldFree(M) {
    return function (nt, fa) {
        if ((0, exports.isPure)(fa)) {
...
function hoistFree(nt) {
    return substFree(function (fa) { return (0, exports.liftF)(nt(fa)); });
}
...
var map_ = function (fa, f) {
    return (0, exports.isPure)(fa) ? exports.free.of(f(fa.value)) : impure(fa.fx, function (x) { return exports.free.map(fa.f(x), f); });
};
var ap_ = function (fab, fa) {
    return exports.free.chain(fab, function (f) { return exports.free.map(fa, f); });
};
var chain_ = function (ma, f) {
    return (0, exports.isPure)(ma) ? f(ma.value) : impure(ma.fx, function (x) { return exports.free.chain(ma.f(x), f); });
};
// -------------------------------------------------------------------------------------
// pipeables
// -------------------------------------------------------------------------------------
 ...
 * @since 0.1.18
 */
var of = function (a) { return ({ _tag: 'Pure', value: a }); };
exports.of = of;
// -------------------------------------------------------------------------------------
// instances
// -------------------------------------------------------------------------------------
 ...
 * @since 0.1.3
 */
var isPure = function (fa) { return fa._tag === 'Pure'; };
 ...
 * @since 0.1.3
 */
var isImpure = function (fa) { return fa._tag === 'Impure'; };
exports.isImpure = isImpure;
