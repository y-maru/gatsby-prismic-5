...
export var fromPredicate = function (predicate) { return function (a) { return (predicate(a) ? some(a) : none); }; };
/**
 * @category constructors
 * @since 0.1.14
 */
 ...
 * @since 0.1.28
 */
export var chainIOK = function (f) { return chain(fromIOK(f)); };
/**
 * @category Monad
 * @since 0.1.18
 */
 ...
 * @since 0.1.28
 */
export var chainFirstIOK = function (f) {
    return chainFirst(fromIOK(f));
};
/**
 * @category Monad
 * @since 0.1.14
