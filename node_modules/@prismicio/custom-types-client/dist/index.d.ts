...
declare class CustomTypesClient {
     ...
     */
    getAll: <TCustomType extends prismicT.CustomTypeModel<string, prismicT.CustomTypeModelDefinition<string>>>(params?: Partial<Pick<CustomTypesClientConfig, "repositoryName" | "endpoint" | "token">> | undefined) => Promise<TCustomType[]>;
    /**
     ...
     */
    getAllCustomTypes<TCustomType extends prismicT.CustomTypeModel>(params?: CustomTypesClientMethodParams): Promise<TCustomType[]>;
    /**
     * @deprecated Renamed to `getCustomTypeByID`.
     */
    getByID: <TCustomType extends prismicT.CustomTypeModel<string, prismicT.CustomTypeModelDefinition<string>>>(id: string, params?: Partial<Pick<CustomTypesClientConfig, "repositoryName" | "endpoint" | "token">> | undefined) => Promise<TCustomType>;
    /**
     ...
     *   cannot be found.
     */
    getCustomTypeByID<TCustomType extends prismicT.CustomTypeModel>(id: string, params?: CustomTypesClientMethodParams): Promise<TCustomType>;
    /**
     * @deprecated Renamed to `insertCustomType`.
     */
    insert: <TCustomType extends prismicT.CustomTypeModel<string, prismicT.CustomTypeModelDefinition<string>>>(customType: TCustomType, params?: Partial<Pick<CustomTypesClientConfig, "repositoryName" | "endpoint" | "token">> | undefined) => Promise<TCustomType>;
    /**
     ...
     *   already exists.
     */
    insertCustomType<TCustomType extends prismicT.CustomTypeModel>(customType: TCustomType, params?: CustomTypesClientMethodParams): Promise<TCustomType>;
    /**
     * @deprecated Renamed to `updateCustomType`.
     */
    update: <TCustomType extends prismicT.CustomTypeModel<string, prismicT.CustomTypeModelDefinition<string>>>(customType: TCustomType, params?: Partial<Pick<CustomTypesClientConfig, "repositoryName" | "endpoint" | "token">> | undefined) => Promise<TCustomType>;
    /**
     ...
     *   cannot be found.
     */
    updateCustomType<TCustomType extends prismicT.CustomTypeModel>(customType: TCustomType, params?: CustomTypesClientMethodParams): Promise<TCustomType>;
    /**
     * @deprecated Renamed to `removeCustomType`.
     */
    remove: <TCustomTypeID extends string>(id: TCustomTypeID, params?: Partial<Pick<CustomTypesClientConfig, "repositoryName" | "endpoint" | "token">> | undefined) => Promise<TCustomTypeID>;
    /**
     ...
     * @throws {@link ForbiddenError} Thrown if the client is unauthorized to make requests.
     */
    removeCustomType<TCustomTypeID extends string>(id: TCustomTypeID, params?: CustomTypesClientMethodParams): Promise<TCustomTypeID>;
    /**
