...
class CustomTypesClient {
  constructor(config) {
    this.getAll = this.getAllCustomTypes.bind(this);
    this.getByID = this.getCustomTypeByID.bind(this);
    this.insert = this.insertCustomType.bind(this);
    this.update = this.updateCustomType.bind(this);
    this.remove = this.removeCustomType.bind(this);
