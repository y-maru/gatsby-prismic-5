...
var parseStringARParam = function (ar) {
    return (0, ramda_1.pipe)(function (v) { return v.split(':'); }, (0, ramda_1.map)(function (part) { return parseFloat(part); }), function (_a) {
        var width = _a[0], height = _a[1];
        return width / height;
    }, function (v) { return (0, number_1.roundToDP)(3, v); })(ar);
};
