...
export declare const createImgixGatsbyTypes: ({ imgixClientOptions, ...params }: Omit<{
    allowlistFields?: ("fixed" | "url" | "fluid" | "gatsbyImageData")[] | undefined;
    namespace?: string | undefined;
    imgixClient: import("./common/imgix-js-core-wrapper").IImgixURLBuilder;
    resolveUrl: import("./common/utils").ImgixSourceDataResolver<unknown, string>;
    resolveHeight?: import("./common/utils").ImgixSourceDataResolver<unknown, number | undefined> | undefined;
    resolveWidth?: import("./common/utils").ImgixSourceDataResolver<unknown, number | undefined> | undefined;
    defaultParams?: {
        ...
        iptc?: string | number | boolean | string[] | number[] | boolean[] | null | undefined;
    ...
    cache: import("gatsby").GatsbyCache;
    ...
    resolveWidth?: ((source: any) => number | undefined) | undefined;
    resolveHeight?: ((source: any) => number | undefined) | undefined;
}) => {
    types: import("graphql-compose").ObjectTypeComposerAsObjectDefinition<any, unknown>[];
    fields: Record<"fixed" | "url" | "fluid" | "gatsbyImageData", import("graphql-compose").ObjectTypeComposerFieldConfigAsObjectDefinition<any, any, any>>;
    inputTypes: import("graphql-compose").InputTypeComposerAsObjectDefinition[];
    enumTypes: import("graphql-compose").EnumTypeComposerAsObjectDefinition[];
};
