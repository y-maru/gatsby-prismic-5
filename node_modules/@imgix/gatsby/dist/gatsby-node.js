...
var log = (0, log_1.createLogger)('gatsby-node');
...
var onPreExtractQueries = function (_a) {
    ...
    fs_1.default.copyFileSync(path_1.default.resolve(__dirname, '../fragments.js'), "".concat(program.directory, "/.cache/fragments/imgix-fragments.js"));
};
