...
import { EnumTypeComposerAsObjectDefinition, InputTypeComposerAsObjectDefinition, ObjectTypeComposerAsObjectDefinition, ObjectTypeComposerFieldConfigAsObjectDefinition } from 'graphql-compose';
 ...
 */
export declare const buildImgixGatsbyTypes: <TSource>({ allowlistFields, imgixClient, resolveUrl, resolveWidth, resolveHeight, defaultParams, cache, namespace, }: {
    allowlistFields?: ("fixed" | "url" | "fluid" | "gatsbyImageData")[] | undefined;
    namespace?: string | undefined;
    imgixClient: IImgixURLBuilder;
    resolveUrl: ImgixSourceDataResolver<TSource, string>;
    resolveHeight?: ImgixSourceDataResolver<TSource, number | undefined> | undefined;
    resolveWidth?: ImgixSourceDataResolver<TSource, number | undefined> | undefined;
    defaultParams?: {
    ...
    types: ObjectTypeComposerAsObjectDefinition<any, unknown>[];
    fields: Record<"fixed" | "url" | "fluid" | "gatsbyImageData", ObjectTypeComposerFieldConfigAsObjectDefinition<any, any, any>>;
    inputTypes: InputTypeComposerAsObjectDefinition[];
    enumTypes: EnumTypeComposerAsObjectDefinition[];
};
