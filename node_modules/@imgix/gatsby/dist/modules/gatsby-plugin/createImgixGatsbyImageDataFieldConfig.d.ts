...
export declare const createImgixGatsbyImageFieldConfig: <TSource, TContext = {}>({ cache, imgixClient, resolveUrl, defaultParams, paramsInputType, placeholderEnumType, resolveWidth, resolveHeight, }: {
...
}) => ObjectTypeComposerFieldConfigAsObjectDefinition<TSource, TContext, IImgixGatsbyImageDataArgsResolved>;
export declare const createImgixGatsbyImageSchemaFieldConfig: <TSource, TContext>(params: Omit<{
    imgixClient: IImgixURLBuilder;
    resolveUrl: ImgixSourceDataResolver<unknown, string>;
    resolveWidth?: ImgixSourceDataResolver<unknown, number | undefined> | undefined;
    resolveHeight?: ImgixSourceDataResolver<unknown, number | undefined> | undefined;
    cache: GatsbyCache;
    defaultParams?: Partial<{
        trim?: string | number | boolean | string[] | number[] | boolean[] | null | undefined;
        auto?: string | number | boolean | string[] | number[] | boolean[] | null | undefined;
...
//# sourceMappingURL=createImgixGatsbyImageDataFieldConfig.d.ts.map