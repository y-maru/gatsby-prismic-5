...
var getFieldValue = function (_a) {
    ...
    return (function () {
        if ('getURL' in fieldOptions) {
            return (0, pipeable_1.pipe)(fieldOptions.getURL(node), function (value) {
            ...
            return (0, pipeable_1.pipe)(fieldOptions.getURLs(node), function (value) {
...
var decodeOptionsE = function (options) {
    return (0, pipeable_1.pipe)(options, publicTypes_1.ImgixGatsbyOptionsIOTS.decode, E.mapLeft(function (errs) {
        return new Error("The plugin config is not in the correct format. Errors: ".concat(PathReporter_1.PathReporter.report(E.left(errs))));
...
var createSchemaCustomization = function (gatsbyContext, _options) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, (0, pipeable_1.pipe)((0, Do_1.Do)(E.either)
                ...
                return (0, typeBuilder_1.buildImgixGatsbyTypes)({
                    cache: gatsbyContext.cache,
                    imgixClient: imgixClient,
                    resolveUrl: (0, ramda_1.prop)('rawURL'),
                ...
                return fields.map(function (fieldOptions) {
                    var _a;
                    return gatsbyContext.schema.buildObjectType({
                        name: "".concat(fieldOptions.nodeType),
                        ...
                        fields: (_a = {},
                            _a[fieldOptions.fieldName] = {
                                type: 'getURLs' in fieldOptions
                                    ? "[".concat(imgixImageType.config.name, "]")
                                    ...
                                    return {
                                        rawURL: E.getOrElseW(function () {
                                            var urlPathsFound = typeof node === 'object' && node != null
                                                ? (0, utils_1.findPossibleURLsInNode)(node)
                                                : [];
                                            return gatsbyContext.reporter.panic("Error when resolving URL value for node type ".concat(fieldOptions.nodeType, ". This probably means that the getURL function in gatsby-config.js is incorrectly set. Please read this project's README for detailed instructions on how to set this correctly.\n                          \n").concat(urlPathsFound.length > 0
                                                ? "Potential images were found at these paths: \n".concat(urlPathsFound
                                                    .map(function (_a) {
                                                    var path = _a.path, value = _a.value;
                                                    return " - ".concat(path, "\n   Usage: getURL: (node) => ").concat(value.startsWith('http') ? "node.".concat(path) : "`https:${node.".concat(path, "}`"));
                                                })
                                                    .join('\n'), "\n")
                                                : '', "\n                          "));
                                        })(rawURLE),
                ...
                gatsbyContext.reporter.panic("[@imgix/gatsby] Fatal error during setup: ".concat(String(err)));
                throw err;
            }))];
    });
}); };
