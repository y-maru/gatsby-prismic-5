...
var resolveGatsbyImageData = function (_a) {
    ...
    return function (rootValue, unsafeResolverArgs) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            return [2 /*return*/, (0, function_1.pipe)((0, Do_1.Do)(TE.taskEither)
                    .sequenceSL(function () { return ({
                    url: (0, utils_1.resolveUrlFromSourceData)(resolveUrl)(rootValue),
                    manualWidth: (0, function_1.pipe)((0, utils_1.taskEitherFromSourceDataResolver)(resolveWidth)(rootValue), fpTsUtils_1.TaskOptionFromTE, TE.fromTask),
                    manualHeight: (0, function_1.pipe)((0, utils_1.taskEitherFromSourceDataResolver)(resolveHeight)(rootValue), fpTsUtils_1.TaskOptionFromTE, TE.fromTask),
                }); })
                    .let('safeResolverArgs', __assign(__assign({}, unsafeResolverArgs), { imgixParams: (0, graphqlTypes_1.unTransformParams)((_a = unsafeResolverArgs.imgixParams) !== null && _a !== void 0 ? _a : {}), placeholderImgixParams: (0, graphqlTypes_1.unTransformParams)((_b = unsafeResolverArgs.placeholderImgixParams) !== null && _b !== void 0 ? _b : {}) }))
                    ...
                    return (0, buildGatsbyImageDataBaseArgs_1.buildGatsbyImageDataBaseArgs)({
                        url: url,
                    ...
                    if (safeResolverArgs.placeholder === 'blurred') {
                        return (0, function_1.pipe)((0, gatsby_plugin_image_1.getLowResolutionImageURL)(__assign(__assign({}, baseImageDataArgs), { options: __assign(__assign({}, baseImageDataArgs), { imgixParams: __assign(__assign(__assign({}, defaultParams), safeResolverArgs.imgixParams), safeResolverArgs.placeholderImgixParams) }) })), (0, fetchBase64Image_1.fetchImgixBase64Image)(cache), TE.map(function (base64Data) { return ({
                            placeholder: { fallback: base64Data },
                        }); }));
                    }
                    if (safeResolverArgs.placeholder === 'dominantColor') {
                        return (0, function_1.pipe)((0, fetchBase64Image_1.fetchImgixDominantColor)(cache)(function (params) {
                    ...
                    return (__assign(__assign({}, (0, gatsby_plugin_image_1.generateImageData)(__assign({}, baseImageDataArgs))), placeholderData));
...
var createImgixGatsbyImageFieldConfig = function (_a) {
    ...
    var defaultConfig = (0, graphql_utils_1.getGatsbyImageFieldConfig)(resolveGatsbyImageData({
        cache: cache,
        imgixClient: imgixClient,
    ...
    var modifiedConfig = __assign(__assign({}, defaultConfig), { args: __assign(__assign({}, (0, ramda_1.pick)([
            'layout',
            'width',
            'height',
            'aspectRatio',
...
exports.createImgixGatsbyImageSchemaFieldConfig = (0, createExternalHelper_1.createExternalHelper)(exports.createImgixGatsbyImageFieldConfig);
