...
var min = function (fallback) {
    ...
    return Math.min.apply(Math, __spreadArray([fallback], rest.filter(isNotNull), false));
};
...
var generateBreakpoints = function (opts) {
    ...
    var widthBreakpoints = width
        ...
        : [];
    return {
        breakpoints: __spreadArray(__spreadArray([], fluidBreakpoints, true), widthBreakpoints, true).sort(function (a, b) { return a - b; }),
    };
};
