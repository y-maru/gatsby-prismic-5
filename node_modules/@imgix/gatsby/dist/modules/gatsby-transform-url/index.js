...
exports.ImgixGatsbyImage = exports.getGatsbyImageData = exports.buildFluidImageData = exports.buildFixedImageData = void 0;
...
function buildImageData(url, imgixParams, options) {
    var _a;
    var host = (0, uri_1.parseHost)(url);
    var path = (0, uri_1.parsePath)(url);
    var client = (0, common_1.createImgixClient)({
        domain: host,
        libraryParam: options.includeLibraryParam === false ? undefined : 'gatsbyTransformUrl',
    });
    var transformedImgixParams = __assign(__assign({ fit: 'crop' }, imgixParams), { ar: imgixParams.ar != null ? "".concat(imgixParams.ar, ":1") : undefined });
    var src = client.buildURL(path, transformedImgixParams);
    var srcset = client.buildSrcSet(path, transformedImgixParams);
    ...
    if (options.type === 'fluid') {
        return {
            sizes: (_a = options.sizes) !== null && _a !== void 0 ? _a : '100vw',
            src: src,
            srcSet: srcset,
            srcWebp: srcWebp,
...
options) {
    ...
    var aspectRatioFloat = (function () {
        ...
        return (0, function_1.pipe)(ar_1.StringAspectRatio.decode(imgixParams.ar), E.map(ar_1.parseStringARParam), E.getOrElse(throwError));
    })();
...
var gatsbyPluginImage_1 = require("./gatsbyPluginImage");
Object.defineProperty(exports, "getGatsbyImageData", { enumerable: true, get: function () { return gatsbyPluginImage_1.getGatsbyImageData; } });
var gatsbyPluginImageComponent_1 = require("./gatsbyPluginImageComponent");
Object.defineProperty(exports, "ImgixGatsbyImage", { enumerable: true, get: function () { return gatsbyPluginImageComponent_1.ImgixGatsbyImage; } });
